                ...
                <Col span="9">
                    <Form ref="form" :model="form" :label-width="85" :rules="formValidate">
                        ...
                        <FormItem label="部门负责人" prop="mainHeader">
                            <Select :loading="userLoading" not-found-text="该部门暂无用户数据" v-model="form.mainHeader" multiple style="width: 400px">
                                <Option v-for="item in users" :value="item.userId" :key="item.userId">{{ item.userName }}</Option>
                            </Select>
                        </FormItem>
                        <FormItem label="副负责人" prop="viceHeader">
                            <Select :loading="userLoading" not-found-text="该部门暂无用户数据" v-model="form.viceHeader" multiple style="width: 400px">
                                <Option v-for="item in users" :value="item.userId" :key="item.userId">{{ item.userName }}</Option>
                            </Select>
                        </FormItem>
...
<script>
import { initDepartment, loadDepartment, addDepartment, editDepartment, deleteDepartment, searchDepartment, getUserByDepartmentId } from '@/api/index';
export default {
